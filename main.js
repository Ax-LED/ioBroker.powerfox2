        ...
        try {
          ...
          if (result.status === 200) {
            ...
            if (data.Watt === undefined || data.A_Plus === undefined) {
              this.log.error(
                `Incomplete data received for device: ${device.name}`,
              );
              continue;
            }
            // --- ENDE ÄNDERUNG ---
            ...
            if (!existingState) {
              ...
              await this.fsetObjectNotExistsAsync(
                `${path}.consumptionMeterReadingKWh`,
                "state",
              ...
              await this.fsetObjectNotExistsAsync(
                `${path}.consumptionMeterReadingHTKWh`,
                "state",
                "consumptionMeterReadingHT",
                "number",
                "value",
                "kWh",
                false,
              ...
              await this.fsetObjectNotExistsAsync(
                `${path}.consumptionMeterReadingNTKWh`,
                "state",
                "consumptionMeterReadingNT",
                "number",
                "value",
                "kWh",
                false,
